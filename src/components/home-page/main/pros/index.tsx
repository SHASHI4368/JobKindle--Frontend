...
const Pros = () => {
  return (
    <div className="w-full flex py-[20px] pt-[100px] bg-gradient-to-r from-[#F1F7FF] to-white items-center justify-start flex-col">
      <h1 className="font-raleway font-[700] sm:leading-[60px] leading-[45px] text-center md:text-[60px] sm:text-[50px] text-[40px] bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
        Why Choose HireMe?
      </h1>
      <p className="text-gray-600 font-raleway md:text-[20px] sm:text-[20px] text-[16px] text-center mt-[40px] sm:max-w-[50vw] max-w-[85vw]">
      ...
      <div className="w-full sm:px-[10vw] px-[5vw] pt-[100px]">
        <div className="w-full bg-gradient-to-r rounded-[15px] shadow-xl p-5 from-primary to-secondary flex flex-col items-center justify-center ">
          <h1 className="font-raleway font-[700] md:text-[45px] sm:text-[43px] text-[35px] sm:leading-[60px] leading-[40px] text-center text-white ">
            Our Impact in Numbers
          </h1>
          <div className="flex font-raleway sm:mt-[20px] mt-[30px] text-white w-full sm:flex-row flex-col items-center justify-evenly sm:gap-0 gap-[20px] ">
      ...
      <div className="flex font-raleway flex-col w-full sm:px-[10vw] px-[5vw] gap-[30px] py-[100px] items-center ">
        ...
        <div className="flex sm:w-fit w-full px-[5vw] sm:flex-row flex-col mt-[30px] items-center justify-center gap-[20px]">
          <Button
            size={"card"}
            className=" text-white sm:w-fit w-full hover:scale-[1.03] transition-all duration-300 font-raleway  shadow-2xs "
          >
            Start Free Trial
          </Button>
          <Button
